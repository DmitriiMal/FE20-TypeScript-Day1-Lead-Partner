...
let menuRow = document.querySelector('.product-list') as HTMLElement;
...
const createRows = () => {
  ...
  let cartRow = document.querySelector('.cart') as HTMLElement;
...
const cartTotal = () => {
  ...
  let result = document.getElementById('cart-price') as HTMLElement;
